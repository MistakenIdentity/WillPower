...
namespace WillPower
{
    ...
    public static class Extensions
    {
        ...
        /// <param name="sourceEncoding">The optional destination <see cref="System.Text.Encoding">Encoding</see> or <see cref="System.Text.Encoding.UTF8">UTF8</see>.</param>
        /// <returns>An <see cref="System.Array">array</see> of bytes from the stream or null.</returns>
        public static byte[] ReadToChar(this System.IO.Stream value, char Terminator, System.Text.Encoding sourceEncoding = null)
        {
            ...
            {
                byte b = (byte)i;
                if (sourceEncoding != System.Text.Encoding.UTF8)
                {
                    b = (new byte[] { (byte)i }).Convert(sourceEncoding, System.Text.Encoding.UTF8)[0];
                }
