...
namespace WillPower
{
    ...
    public sealed partial class UniForm : Window
    {
        ...
        {
            InitializeComponent();
            this.CloseWindow.ToolTip = UI.WPF.Properties.Resources.Close;
            this.MaxWindow.ToolTip = UI.WPF.Properties.Resources.Maximize;
            this.MinWindow.ToolTip = UI.WPF.Properties.Resources.Minimize;
        }
        /// <summary>
        /// Creates a new Instance of UniForm.
        /// </summary>
        ...
        private void Window_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            Application.Current.Invoke(delegate
            {
                if (this.WindowState == WindowState.Maximized)
                {
                    ...
                    this.MaxWindow.ToolTip = UI.WPF.Properties.Resources.RestoreDown;
                }
                else
                {
